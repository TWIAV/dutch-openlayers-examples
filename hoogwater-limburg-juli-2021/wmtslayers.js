...
const luchtfoto2021OrthoHRRGBLayer = new TileLayer({
  ...
  source: new WMTSSource({
    ...
    attributions: 'PDOK: <a href="https://www.pdok.nl/introductie/-/article/pdok-luchtfoto-rgb-open-" target="_blank" title="Publieke Dienstverlening Op de Kaart">Luchtfoto 2021 (7,5 cm)</a>'
  })
});
